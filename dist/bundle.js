...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_state_js_1) {
    ...
    class ProjectInput extends base_component_js_1.Component {
        ...
        gatherUserInput() {
            ...
            const titleValidatabale = {
                value: enteredTitle,
                required: true
            };
            const descriptionValidatabale = {
                value: enteredDescription,
                required: true,
                minLength: 5
            };
            const peopleValidatabale = {
                value: +enteredPeople,
                required: true,
                min: 1,
                max: 5
            };
            if (!(0, validation_js_1.validate)(titleValidatabale) ||
                !(0, validation_js_1.validate)(descriptionValidatabale) ||
                !(0, validation_js_1.validate)(peopleValidatabale)) {
